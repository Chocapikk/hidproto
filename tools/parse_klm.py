...
KEY_LABELS = {
    "KEY_EN_ESCAPE": "Esc", "KEY_EN_F1": "F1", "KEY_EN_F2": "F2",
    "KEY_EN_F3": "F3", "KEY_EN_F4": "F4", "KEY_EN_F5": "F5",
    "KEY_EN_F6": "F6", "KEY_EN_F7": "F7", "KEY_EN_F8": "F8",
    "KEY_EN_F9": "F9", "KEY_EN_F10": "F10", "KEY_EN_F11": "F11",
    "KEY_EN_F12": "F12", "KEY_EN_BACK_TICK": "`", "KEY_EN_1": "1",
    "KEY_EN_2": "2", "KEY_EN_3": "3", "KEY_EN_4": "4", "KEY_EN_5": "5",
    "KEY_EN_6": "6", "KEY_EN_7": "7", "KEY_EN_8": "8", "KEY_EN_9": "9",
    "KEY_EN_0": "0", "KEY_EN_MINUS": "-", "KEY_EN_EQUALS": "=",
    "KEY_EN_BACKSPACE": "Bksp", "KEY_EN_TAB": "Tab", "KEY_EN_Q": "Q",
    "KEY_EN_W": "W", "KEY_EN_E": "E", "KEY_EN_R": "R", "KEY_EN_T": "T",
    "KEY_EN_Y": "Y", "KEY_EN_U": "U", "KEY_EN_I": "I", "KEY_EN_O": "O",
    "KEY_EN_P": "P", "KEY_EN_LEFT_BRACKET": "[", "KEY_EN_RIGHT_BRACKET": "]",
    "KEY_EN_ANSI_BACK_SLASH": "\\", "KEY_EN_CAPS_LOCK": "Caps",
    "KEY_EN_A": "A", "KEY_EN_S": "S", "KEY_EN_D": "D", "KEY_EN_F": "F",
    "KEY_EN_G": "G", "KEY_EN_H": "H", "KEY_EN_J": "J", "KEY_EN_K": "K",
    "KEY_EN_L": "L", "KEY_EN_SEMICOLON": ";", "KEY_EN_QUOTE": "'",
    "KEY_EN_POUND": "#", "KEY_EN_ANSI_ENTER": "Enter",
    "KEY_EN_LEFT_SHIFT": "Shift", "KEY_EN_ISO_BACK_SLASH": "\\",
    "KEY_EN_Z": "Z", "KEY_EN_X": "X", "KEY_EN_C": "C", "KEY_EN_V": "V",
    "KEY_EN_B": "B", "KEY_EN_N": "N", "KEY_EN_M": "M", "KEY_EN_COMMA": ",",
    "KEY_EN_PERIOD": ".", "KEY_EN_FORWARD_SLASH": "/",
    "KEY_EN_RIGHT_SHIFT": "Shift", "KEY_EN_LEFT_CONTROL": "Ctrl",
    "KEY_EN_LEFT_WINDOWS": "Win", "KEY_EN_LEFT_ALT": "Alt",
    "KEY_EN_SPACE": "Space", "KEY_EN_RIGHT_ALT": "Alt",
    "KEY_EN_RIGHT_FUNCTION": "Fn", "KEY_EN_MENU": "Menu",
    "KEY_EN_RIGHT_CONTROL": "Ctrl", "KEY_EN_PRINT_SCREEN": "PrtSc",
    "KEY_EN_SCROLL_LOCK": "ScrLk", "KEY_EN_PAUSE_BREAK": "Pause",
    "KEY_EN_INSERT": "Ins", "KEY_EN_HOME": "Home", "KEY_EN_PAGE_UP": "PgUp",
    "KEY_EN_DELETE": "Del", "KEY_EN_END": "End", "KEY_EN_PAGE_DOWN": "PgDn",
    "KEY_EN_UP_ARROW": "Up", "KEY_EN_LEFT_ARROW": "Left",
    "KEY_EN_DOWN_ARROW": "Down", "KEY_EN_RIGHT_ARROW": "Right",
    "KEY_EN_NUMPAD_LOCK": "Num", "KEY_EN_NUMPAD_DIVIDE": "/",
    "KEY_EN_NUMPAD_TIMES": "*", "KEY_EN_NUMPAD_MINUS": "-",
    "KEY_EN_NUMPAD_7": "7", "KEY_EN_NUMPAD_8": "8", "KEY_EN_NUMPAD_9": "9",
    "KEY_EN_NUMPAD_PLUS": "+", "KEY_EN_NUMPAD_4": "4",
    "KEY_EN_NUMPAD_5": "5", "KEY_EN_NUMPAD_6": "6", "KEY_EN_NUMPAD_1": "1",
    "KEY_EN_NUMPAD_2": "2", "KEY_EN_NUMPAD_3": "3",
    "KEY_EN_NUMPAD_ENTER": "Ent", "KEY_EN_NUMPAD_0": "0",
...
ZONE_PATTERN = re.compile(
    r"static\s+const\s+std::vector<keyboard_led>\s+(\w+)\s*="
)
    ...
    for zone_name, keys in zones.items():
        ...
        for k in keys:
            if k["label"]:
                ...
                lines.append(
                    f'    Key("{label}", {k["row"]}, {k["col"]}, "{k["name"]}"),'
                )
        lines.append("]")
        lines.append("")
